  ...
  if (cartItems.length === 0) {
    return (
      <div className="container mx-auto px-4 py-16 text-center mt-16">
        ...
        <Link to="/menu" className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-6 py-2 rounded-full inline-block hover:scale-105 transition">
          Browse Menu
        </Link>
      </div>
    );
    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl mt-16">
      ...
      <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 mt-2">
                  <button 
                    ...
                    className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 transition"
                  >
                    -
                  </button>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 h-fit sticky top-24">
          ...
          <Link to="/checkout">
            <button className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white py-3 rounded-lg font-semibold text-center hover:scale-105 transition">
              Proceed to Checkout
            </button>
          </Link>
        </div>
